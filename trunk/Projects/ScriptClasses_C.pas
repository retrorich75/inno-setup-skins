...
procedure RegisterSkinManager_C(Cl: TPSPascalCompiler);
begin
  with Cl.AddClassN(Cl.FindClass('TComponent'),'TsSkinManager') do
  begin
    RegisterProperty('SkinDirectory', 'String', iptrw);
    RegisterProperty('SkinName', 'String', iptrw);
  end;
end;
...
begin
  ...
  begin
    ...
    RegisterProperty('SkinManager', 'TsSkinManager', iptr);

...
uses
  ...
  FolderTreeView, BitmapImage, NewNotebook, ScriptDlg, BidiCtrls, sSkinManager,
  UninstProgressForm;
...
procedure TsSkinManagerSkinDirectory_R(Self: TsSkinManager; var T: String); begin T := Self.SkinDirectory; end;
procedure TsSkinManagerSkinDirectory_W(Self: TsSkinManager; T: String); begin Self.SkinDirectory := T; end;
procedure TsSkinManagerSkinName_R(Self: TsSkinManager; var T: String); begin T := Self.SkinName; end;
procedure TsSkinManagerSkinName_W(Self: TsSkinManager; T: String); begin Self.SkinName := T; end;

procedure RegisterSkinManager_R(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TsSkinManager) do
  begin
    RegisterPropertyHelper(@TsSkinManagerSkinDirectory_R,@TsSkinManagerSkinDirectory_W,'SkinDirectory');
    RegisterPropertyHelper(@TsSkinManagerSkinName_R,@TsSkinManagerSkinName_W,'SkinName');
  end;
end;
...
procedure TWizardFormSkinManager_R(Self: TWizardForm; var T: TsSkinManager); begin T := Self.SkinManager; end;
...
begin
  ...
  begin
    ...
    RegisterPropertyHelper(@TWizardFormSkinManager_R, nil, 'SkinManager');
